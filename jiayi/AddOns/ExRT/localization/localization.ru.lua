...
L.NoteHelpAdv3 = "Данный пример будет заменен на динамический таймер для определенного времени боя с боссом. Таймер будет активен только после запуска его вручную. Используйте команду чата \"|cffffff00/rt note starttimer customevent|r\" или lua функцию \"|cffffff00GExRT.F.Note_Timer(\"customevent\")|r\""
L.NoteHelpAdv4 = "Данный пример будет заменен на динамический таймер для определенного времени боя с боссом. Вместе с данным дополнительным условием будет вызываться событие в аддоне weakauras. Название события |cffffff00EXRT_NOTE_TIME_EVENT|r. Событие будет вызываться за 20,15,10,5,4,3,2,1,0 секунд на таймере. 1 аргумент события это его название (|cffffff00nzoth_hs1|r в текущем примере), 2 аргумент - оставшееся время на таймере, целое число, 3 аргумент - сообщение в заметке после таймера до конца строки."
...
L.RaidCheckNoAddonOptTooltip = "Проверяются только игроки с аддоном ExRT. Игроки без аддона будут выделены отдельно"
...
L.cd2ColSetCDTimeExRT = "Текст ExRT"
