...
L["%player% interrupted %target%'s %target_spell%!"] = "%player% прерывает %target%'s %target_spell%!"
...
L["Add a bar contains buttons to enable/disable modules quickly."] = "Добавить панель, содержащую кнопки для быстрого включения / отключения модулей."
...
L["Alliance"] = "Альянс"
L["Allow you to save outfits even if the artifact in it."] = "Позволяют сохранять комплекты, даже если есть артефакт в нем."
L["Allow you to use Delete Key for confirming deleting."] = "Разрешить вам использовать клавишу удаления для подтверждения удаления."
...
L["Alt Key"] = "Альтернативная кнопка"
...
L["Change the icons indicate the role."] = "Изменить значки указывающие на роль."
...
L["Click to confirm"] = "Нажмите, чтобы подтвердить"
...
L["De Other Side"] = "С другой стороны"
...
L["Display character equipments list when you inspect someone."] = "Отображать список экипировки персонажа, когда вы кого-то осматриваете."
...
L["Enhanced Texuture"] = "Улучшенная текстура"
...
L["Export the setting of %s that stored in ElvUI Private database."] = "Экспортируйте настройки %s, которая хранится в базе данных приват ElvUI."
L["Export the setting of %s that stored in ElvUI Profile database."] = "Экспортируйте настройки %s, которая хранится в базе данных профиля ElvUI."
...
L["Hide channels not exist."] = "Скрыть не существующие каналы"
...
L["I interrupted %target%'s %target_spell%!"] = "Я прервал %target% 's %target_spell%!"
...
L["It doesn't means that the %s Skins will not be applied."] = "Это не означает, что скины %s не будут применены."
...
L["Open the passageway to Rogue Class Hall automatically."] = "Автоматически открыть проход в оплот класса Разбойника."
...
L["Press modifier key (Shift, Ctrl, Alt) to stop the automation temporarily."] = "Нажмите клавишу-модификатор (Shift, Ctrl, Alt), чтобы временно остановить автоматизацию."
...
L["Reset Instance"] = "Сбросить подземелья"
...
L["Save Artifact"] = "Сохранить артефакт"
...
L["Target is not exists."] = "Цель не существует."
...
L["Thanks For Resurrection"] = "Спасибо за воскрешение"
L["Thanks Text"] = "Текст благодарности"
L["Thanks all!"] = "Спасибо всем!"
...
L["Use Delete Key"] = "Использовать клавишу удаления"
