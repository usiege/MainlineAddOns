...
L["%player% taunted all enemies in 10 yards!"] = "%player%님이 10미터 내에 있는 모든 적을 도발합니다!"
...
L["%s may cause some frames to get messed, but you can use %s button to reset frames."] = "%s로 인해 일부 프레임의 배경이 혼동될 수 있지만 %s 버튼을 눌러 프레임을 재설정 할 수 있습니다."
L["%target%, thank you for soulstone. :)"] = "%target%님 영혼석 감사합니다!"
L["%target%, thank you for using %spell% to revive me. :)"] = "%target%님 부활 감사합니다!"
L["(Modifer Click) Collect Garbage"] = "(가운데 버튼 클릭) Collect Garbage"
...
L["Add a bar contains buttons to enable/disable modules quickly."] = "모듈의 활성/비활성을 빠르게 전환할 수 있는 스위치 버튼 바를 추가합니다."
...
L["Add an icon indicates the status of the permission of changing talents."] = "특성 변경 가능 여부를 확인할 수 있는 아이콘을 추가합니다."
...
L["Add progress information (Ex. Mob 10/25)."] = "진행 정보 추가 (예：몹 10/25)"
...
L["Add tomb and codex buttons."] = "고서 및 전서 버튼을 추가합니다."
...
L["Alliance"] = "얼라이언스"
L["Allow you to save outfits even if the artifact in it."] = "유물 무기가 포함된 의상 세트를 저장할 수 있습니다."
L["Allow you to use Delete Key for confirming deleting."] = "아이템 파괴 확인을 위해 Delete 키를 사용합니다."
L["Alpha"] = "투명도"
L["Alpha Max"] = "최대 알파 값"
L["Alpha Min"] = "최소 알파 값"
L["Already Known"] = "이미 알고 있는 항목"
L["Already have a set named %s."] = "%s 세트가 이미 있습니다."
L["Alt Key"] = true
...
L["Announce the new mythic keystone."] = "새로운 쐐기돌 획득 시 알림."
L["Announcement"] = "알림"
...
L["Calendar"] = "달력"
L["Candidate"] = true
L["Cannot get the armory link."] = "전투정보실 링크를 가져올 수 없습니다."
L["Cannot get the name."] = "이름을 가져올 수 없습니다."
...
L["Change the icons indicate the role."] = "역할을 나타내는 아이콘을 변경합니다."
...
L["Enhanced Texuture"] = "텍스처 설정"
L["Enter Color"] = "시작 색상"
L["Enter Combat"] = ">>전투 시작<<"
L["Enter Text"] = "시작 문자"
L["Equipments"] = "장비"
L["Error Mesage"] = "에러 메시지"
L["Europe"] = "유럽"
L["Exalted"] = "고귀한 동맹"
L["Example"] = "예시"
...
L["I have learned a lot from their codes."] = "나는 그들의 코드에서 많은 것을 배웠습니다."
L["I interrupted %target%'s %target_spell%!"] = "%target%의 %target_spell% 차단 성공!"
L["I taunted %target% successfully!"] = "%target% 도발 성공!"
L["I taunted all enemies in 10 yards!"] = "10미터 내에 있는 모든 적을 도발했습니다!"
L["IL"] = "인던 리더"
L["Icon"] = "아이콘"
...
L["Monk"] = "수도사"
L["Monochrome"] = "단색화"
L["More features are comming soon."] = "더 많은 기능이 곧 제공될 예정입니다."
L["Mount"] = "탈것"
L["Mouse"] = "마우스"
L["Mouse Over"] = "마우스 오버"
...
L["Open the passageway to Rogue Class Hall automatically."] = "도적 - 그림자의 전당으로 가는 통로가 자동으로 열립니다."
...
L["Others"] = "기타"
L["Outline"] = "외곽선"
L["Override your ElvUI profile with %s profile."] = "%s 프로필로 ElvUI 프로필을 재설정합니다."
L["Overwrite"] = "덮어쓰기"
L["P"] = "파티"
L["PL"] = "파티장"
L["Paladin"] = "성기사"
...
L["Press modifier key (Shift, Ctrl, Alt) to stop the automation temporarily."] = "자동 수락을 일시적으로 중지하려면 기능키(Shift, Ctrl, Alt)를 누른 상태로 클릭하세요."
...
L["Remove the unit from distance text."] = "거리 문자에서 단위를 제거합니다."
L["Rename"] = "이름 변경"
L["Rename Set"] = "세트 이름 변경"
L["Replay"] = "리플레이"
L["Report Stats"] = "내 스탯 전송"
L["Reputation panel"] = "평판 패널"
L["Reset"] = "리셋"
...
L["Reskin the instance diffculty in text style."] = "미니맵의 인스턴스 난이도를 문자 형식으로 변경합니다."
L["Reskinning the role icons."] = "역할 아이콘을 변경합니다."
...
L["Save and learn talents by one-click."] = "한번의 클릭으로 특성을 저장하고 변경합니다."
L["Say"] = "일반 대화"
L["Say goodbye after dungeon completed."] = "던전 완료 후 작별 인사하세요."
L["Say thanks to the target who resurrected you."] = "당신을 부활한 대상에게 감사를 표현하세요."
L["Scale"] = "크기"
L["Scenario"] = true
...
L["Shadowlands"] = "어둠땅"
L["Shadowlands Keystone Master: Season One"] = "어둠땅 쐐기돌 장인: 1 시즌"
L["Shadowmoon"] = true
L["Shaman"] = "주술사"
L["Shift Key"] = true
L["Short"] = "짧게"
...
L["Support 16:9, 21:9 and 32:9!"] = "16:9, 21:9, 32:9 해상도를 지원합니다!"
...
L["Tags"] = "태그"
L["Taiwan"] = "대만"
L["Talent Manager"] = "특성 관리자"
L["Talent string is not valid."] = "특성 문자열이 유효하지 않습니다."
L["Talents"] = "전문화"
L["Talking Head"] = true
L["Tank"] = "탱커"
L["Target"] = "대상"
...
L["Target is not exists."] = "대상이 없습니다."
L["Target name"] = "대상 이름"
L["Taunt"] = "도발"
L["Taxi"] = true
...
L["Thanks For Resurrection"] = "부활 감사합니다!"
...
L["The feature is just a part of that module."] = "이 기능은 해당 모듈의 일부일 뿐입니다."
...
L["The localization of %s is community-driven."] = "%s의 현지화는 커뮤니티에서 주도하고 있습니다."
L["The name of the player"] = "플레이어 이름"
L["The percentage of current health without percent sign"] = "현재 체력의 백분율 (퍼센트 기호 제거)"
...
L["Toggle Talent Manager"] = "특성 관리자 토글"
...
L["[ABBR] Back"] = "등"
L["[ABBR] Castle Nathria"] = "나스리아 성채"
L["[ABBR] Chest"] = "가슴"
L["[ABBR] Community"] = "C"
L["[ABBR] De Other Side"] = "저 편"
L["[ABBR] Emote"] = "E"
L["[ABBR] Event Scenario"] = "이벤"
L["[ABBR] Feet"] = "발"
L["[ABBR] Finger"] = "손가락"
L["[ABBR] Guild"] = "G"
L["[ABBR] Halls of Atonement"] = "속죄의 전당"
L["[ABBR] Hands"] = "손"
L["[ABBR] Head"] = "머리"
...
L["[ABBR] Mists of Tirna Scithe"] = "티르너 사이드의 안개"
L["[ABBR] Mythic"] = "신화"
L["[ABBR] Mythic Keystone"] = "쐐기"
L["[ABBR] Neck"] = "목"
L["[ABBR] Normal"] = "일반"
L["[ABBR] Officer"] = "O"
L["[ABBR] Party"] = "P"
L["[ABBR] Party Leader"] = "PL"
L["[ABBR] Plaguefall"] = "역병 몰락지"
L["[ABBR] Raid"] = "R"
L["[ABBR] Raid Finder"] = "공찾"
L["[ABBR] Raid Leader"] = "RL"
L["[ABBR] Raid Warning"] = "RW"
L["[ABBR] Roll"] = "RL"
L["[ABBR] Sanguine Depths"] = "핏빛 심연"
L["[ABBR] Say"] = "S"
L["[ABBR] Scenario"] = "시나리오"
L["[ABBR] Shadowlands Keystone Master: Season One"] = "쐐기돌 장인 1시즌"
L["[ABBR] Shoulders"] = "어깨"
L["[ABBR] Spires of Ascension"] = "승천의 첨탑"
L["[ABBR] The Necrotic Wake"] = "죽음의 상흔"
L["[ABBR] Theater of Pain"] = "고통의 투기장"
